...
| [wordpress-malware-removal](https://github.com/adityaarsharma/wordpress-malware-removal) | A hacked WordPress site hides cloaking, backdoors, and DB injection that in-dashboard scanners miss. | Three agent skills — audit, clean, harden — over SSH or any WP MCP. 12-layer forensic scan, quarantine-first removal with rollback, A–F posture score. Claude Code, Cursor, Codex. | ![Stars](https://img.shields.io/github/stars/adityaarsharma/wordpress-malware-removal?style=flat-square&color=gold) |
